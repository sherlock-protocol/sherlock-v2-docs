...
1. Definite loss of funds without (extensive) limitations of external conditions. Extensive limitations cannot be controlled by the attacker. The loss must exceed 75%.
